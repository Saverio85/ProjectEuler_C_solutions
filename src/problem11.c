...
long checkDirection(int data[size][size], int i, int j, int orizontal, int vertical);
...
long checkDirection(int data[size][size], int i, int j, int orizontal, int vertical)
{
	...
	{
		return data[i][j] * 
			data[i + vertical][j + orizontal] *
			data[i + 2*vertical][j + 2*orizontal] * 
			data[i + 3*vertical][j + 3*orizontal];
	}
	return 0;
}
